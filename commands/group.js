...
cmd(
  ...
  async (Void, citel, text, { isCreator }) => {
    ...
    await Void.groupAcceptInvite(result)
      .then((res) => citel.reply("☑️ Joined Group"))
...
cmd(
  ...
  async (Void, citel, text) => {
    ...
    await Void.sendMessage(`${citel.sender}`, {
      image: log0,
      caption: `*Group Name: [•ᴠɪꜱʜᴡᴀ-ᴍᴅ-ꜱᴜᴘᴘᴏʀᴛ•]*\n*Group Link:* https://chat.whatsapp.com/GSJ3mmEI1g11dj0WHgCcC4`,
    });
  },
);
  ...
  async (Void, citel, text, { isCreator }) => {
    ...
    function Z() {
      const F = [
        "126402oKAcRa",
        "date",
        "Removing\x20User\x20because\x20Warn\x20limit\x20exceeded\x0a\x0a*All\x20Warnings.*\x0a",
        "chat",
        "8qachoN",
        "580yXDZAo",
        ...
        "1100323uEahgH",
        "30204512uUuJcj",
        "*There\x20are\x20total\x20",
        "split",
        "│\x20*⚠️Warned\x20by:-*\x20",
        "length",
        "sender",
        "setDefault",
        "group",
    ...
    (function (U, w) {
      ...
      while (!![]) {
        try {
          const q =
            (parseInt(c(0x1eb)) / 0x1) * (parseInt(c(0x1f0)) / 0x2) +
            (parseInt(c(0x1e7)) / 0x3) * (parseInt(c(0x1ef)) / 0x4) +
            (-parseInt(c(0x200)) / 0x5) * (-parseInt(c(0x204)) / 0x6) +
            (-parseInt(c(0x1f5)) / 0x7) * (-parseInt(c(0x1dd)) / 0x8) +
            (-parseInt(c(0x1f3)) / 0x9) * (-parseInt(c(0x1de)) / 0xa) +
            (parseInt(c(0x1f1)) / 0xb) * (parseInt(c(0x1e0)) / 0xc) +
            -parseInt(c(0x1f6)) / 0xd;
          if (q === w) break;
          else s["push"](s["shift"]());
        } catch (B) {
          s["push"](s["shift"]());
    ...
    if (!citel["quoted"])
      return citel[S(0x1e1)]("Please\x20quote\x20a\x20user\x20master.");
    ...
    try {
      ...
      Void["sendMessage"](
        citel["chat"],
        {
          text:
            S(0x1f2) +
            citel[S(0x1e8)][S(0x1fb)][S(0x1f8)]("@")[0x0] +
            "\x0aWith\x20Reason:\x20" +
            text +
            "\x0aWarned\x20by:\x20" +
            citel[S(0x1ed)],
      ...
      if (h[S(0x1fa)] > Config["warncount"]) {
        ...
        teskd += S(0x1f7) + h[S(0x1fa)] + "\x20\x20warnings.*\x0a";
        for (let i = 0x0; i < h[S(0x1fa)]; i++) {
          (teskd += "*" + (i + 0x1) + S(0x1ea) + h[i][S(0x1fd)] + "\x0a"),
            (teskd += S(0x1e3) + h[i][S(0x205)] + "\x0a"),
            (teskd += S(0x1f9) + h[i][S(0x1ec)] + "\x0a"),
            (teskd +=
              "│\x20_📍Reason:\x20" +
              h[i][S(0x1ee)] +
              "_\x0a╰─────────────◆\x0a\x0a");
...
cmd(
  ...
  async (Void, citel, text, { isCreator }) => {
    if (!isCreator)
      return citel.reply("```🧚‍♂️ Only My Owner Can Use This Command```");
    ...
    if (!isBotAdmins)
      return citel.reply("*_I'm Not Admin Here, So I Can't Promote Someone_*");
    if (!isAdmins) return citel.reply(tlang().admin);
...
cmd(
  ...
  async (Void, citel, text, { isCreator }) => {
    ...
    const isAdmins = citel.isGroup ? groupAdmins.includes(citel.sender) : false;
    if (!isBotAdmins)
      return await citel.reply(`*_🙂 I'm Not Admin In This Group, Idiot_*`);
    if (!isAdmins) return citel.reply(tlang().admin);
    ...
    try {
      ...
      return await Void.sendMessage(
        users,
        { text: "🥺 Error While Demote User : " + e },
        { quoted: citel },
      );
    }
  },
